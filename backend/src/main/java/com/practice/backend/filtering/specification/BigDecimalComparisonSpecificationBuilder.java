...
public class BigDecimalComparisonSpecificationBuilder<EntityType> implements SpecificationBuilder<EntityType> {
    ...
    public Specification<EntityType> buildSpecification(SearchCriteria searchCriteria) {
        return new BigDecimalComparisonSpecification<>(searchCriteria);
    }
