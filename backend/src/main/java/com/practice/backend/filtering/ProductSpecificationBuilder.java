...
public class ProductSpecificationBuilder implements EntityFilterSpecificationBuilder<Product> {
    ...
    private static final List<FilterableProperty<Product>> FILTERABLE_PROPERTIES = List.of(
            new FilterableProperty<>(Product_.NAME, String.class, EqualingOrNullSpecificationBuilder.SUPPORTED_OPERATORS, new EqualingOrNullSpecificationBuilder<>()),
            new FilterableProperty<>(Product_.DESCRIPTION, String.class, StringComparisonSpecificationBuilder.SUPPORTED_OPERATORS, new StringComparisonSpecificationBuilder<>()),
            new FilterableProperty<>(Product_.PRICE, Object.class, BigDecimalComparisonSpecificationBuilder.SUPPORTED_OPERATORS, new BigDecimalComparisonSpecificationBuilder<>()));
